 ...
 * --------- PROMISE METHODS -----------------
 * 
 * main static Promise methods: 
 * ✅ 1. Promise.all() - Waits for all promises to fulfill. If any fails, the entire thing fails.
 */
 ...
 Promise.all([
  ...
  .then(values => {
    console.log("Resolved values:", values); // ["First", "Second", "Third"]
    return values;
  })
  .catch(err => {
